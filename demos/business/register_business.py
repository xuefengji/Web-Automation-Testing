...
class RegisterBusiness(object):
    ...
    def send_info(self,email,name,pwd,filename):
    ...
    #执行操作
    def login_email_error(self,email,name,pwd,filename):
        self.send_info(email,name,pwd,filename)
    ...
    def login_name_error(self,email,name,pwd,filename):
        self.send_info(email,name,pwd,filename)
    ...
    def login_password_error(self,email,name,pwd,filename):
        self.send_info(email,name,pwd,filename)
    ...
    def login_code_error(self,email,name,pwd,filename):
        self.send_info(email,name,pwd,filename)
